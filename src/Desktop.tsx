...
const imgRectangle =
  "https://www.figma.com/api/mcp/asset/f844113f-1290-4f7b-b756-c9535804cb22";
const imgFrame1 =
  "https://www.figma.com/api/mcp/asset/02fbf0e9-c541-4384-803f-4321a85ee6d8";
const imgFrame2 =
  "https://www.figma.com/api/mcp/asset/e0923268-6f18-4df0-ae85-39b05ed232bd";
const imgDesktop26 =
  "https://www.figma.com/api/mcp/asset/d8baf606-7142-447f-b9aa-04a9911bb6a1";
const imgVector4 =
  "https://www.figma.com/api/mcp/asset/55fb0323-a424-40d2-9958-86933ccf386f";
const imgFrame3 =
  "https://www.figma.com/api/mcp/asset/842c0cd8-1f2f-4c48-8de9-8128e92d7a43";
const imgFrame4 =
  "https://www.figma.com/api/mcp/asset/256366d0-8148-4eea-baa8-73c5a924ec4d";
const imgFrame5 =
  "https://www.figma.com/api/mcp/asset/5903a1ca-3171-416d-87ae-ad2f6d22a0f9";
const imgFrame6 =
  "https://www.figma.com/api/mcp/asset/55dee613-3f2f-4140-be7d-fdc93e219c8d";
const imgFrame7 =
  "https://www.figma.com/api/mcp/asset/f74c68f7-e3a7-40aa-935c-093bc641d169";
const imgFrame8 =
  "https://www.figma.com/api/mcp/asset/63ea9bc1-d2b3-46ab-8a03-c347afe5e79f";
const imgFrame9 =
  "https://www.figma.com/api/mcp/asset/e2393502-2eb6-4e91-b72f-9937e53660bd";
const imgFrame10 =
  "https://www.figma.com/api/mcp/asset/7f2cd933-7f31-43e8-b2b4-6cc7d9e92dd5";
const imgFrame11 =
  "https://www.figma.com/api/mcp/asset/df202efd-4ecf-4c88-a8bf-0028829d268a";
const imgFrame12 =
  "https://www.figma.com/api/mcp/asset/0faa2a3b-36c3-4cc6-966a-9c20e7bc612d";
const imgFrame13 =
  "https://www.figma.com/api/mcp/asset/a8ecb1c0-3e37-427e-9742-43657463e3d7";
const imgVector =
  "https://www.figma.com/api/mcp/asset/45dfd35e-c297-4d61-ade7-f9638d7c3a99";
const imgVector1 =
  "https://www.figma.com/api/mcp/asset/13f7df68-6b6d-4bb0-997a-81e7a90df652";
const imgFrame =
  "https://www.figma.com/api/mcp/asset/23405a3e-0c8d-4d7e-8407-204e16b3f18e";
const imgLogo =
  "https://www.figma.com/api/mcp/asset/fca9d28e-3bd3-4849-988e-84da44df3ecc";
const imgVector2 =
  "https://www.figma.com/api/mcp/asset/37dd5450-d8ed-4876-8bba-798ffa39318d";
const imgVector3 =
  "https://www.figma.com/api/mcp/asset/d46ce243-3311-444a-938c-1cbaa2903e2e";
const imgFrame14 =
  "https://www.figma.com/api/mcp/asset/bbcfd9b9-ad14-4adb-9f2a-3a7f383b5089";
const imgVector5 =
  "https://www.figma.com/api/mcp/asset/e40cc6a4-0c2b-4b0c-a6f0-bb5beeab8d3a";
...
function EventCard({
  ...
  const text = (
    <div className="flex flex-[1_0_0] flex-col gap-[40px] items-start min-w-0">
      ...
      <div className="text-[28px] font-medium text-[#6e7177] tracking-[-0.84px] leading-[1.3]">
        {description}
      </div>
    </div>
  );
  ...
  return (
    <div
      ref={ref}
      className="flex gap-[80px] items-center px-[20px] shrink-0 w-full transition-all duration-700"
      style={{
        opacity: visible ? 1 : 0,
...
function MemberCard({
  ...
  return (
    <div className="group bg-[#0c0c0d] flex flex-col gap-[10px] items-start overflow-hidden p-[10px] rounded-[16px] shadow-[10px_10px_8px_0px_rgba(0,0,0,0.1)] shrink-0 transition-transform duration-300 hover:-translate-y-2 hover:shadow-[10px_16px_20px_0px_rgba(0,0,0,0.18)] cursor-default">
      <div className="relative h-[300px] w-[240px] overflow-hidden rounded-[8px]">
        <img
          alt={name}
          className="absolute max-w-none transition-transform duration-500 group-hover:scale-105"
          src={img}
          style={style}
        />
      </div>
...
export function Desktop() {
  ...
  useEffect(() => {
    const sectionIds = ["people", "history", "event", "about"];
  ...
  return (
    <div className="flex flex-col items-start w-full bg-[#fafafa]">
      ...
      {/* ── Fixed nav ── */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-[80px] py-[24px] transition-all duration-300"
        style={{
          background: scrolled
      ...
      >
        <button
          ...
          className="flex items-center gap-[2px] overflow-clip px-[4px] py-[6px] transition-opacity duration-200 hover:opacity-70"
        >
          ...
          <span
            className="font-bold text-[32px] leading-[1.3] transition-colors duration-300"
        ...
        <div
          className="flex items-start p-[10px] rounded-[56px] transition-all duration-300"
          style={{
            border: scrolled ? "0.5px solid rgba(12,12,13,0.2)" : "0.5px solid #fafafa",
          }}
        >
          {NAV_ITEMS.map(({ label, href }) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive
                    ? scrolled ? "rgba(26,122,255,0.1)" : "rgba(255,255,255,0.2)"
                    : "transparent",
                }}
              >
                <span
                  className="font-medium text-[18px] tracking-[-0.72px] leading-[1.3] transition-colors duration-300"
                  style={{
                    color: isActive
                      ? scrolled ? "#1a7aff" : "#fff"
                      : scrolled ? "#0c0c0d" : "#fafafa",
                  }}
                >
                  {label}
                </span>
      ...
      <div id="home" className="relative h-[100vh] min-h-[900px] w-full shrink-0 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <img
            ...
            src={imgRectangle}
            style={{ height: "217.08%", top: "-66.58%" }}
          />
          <div
            className="absolute inset-0"
            style={{
              backgroundImage:
                "linear-gradient(180deg, rgba(255,255,255,0) 55%, rgba(255,255,255,0.85) 88%, #fafafa 100%)",
            }}
          />
        </div>

        {/* Large hero text */}
        <div className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-[47%] text-[#fafafa] font-bold text-[240px] tracking-[-9.6px] leading-[1.3] text-center whitespace-nowrap select-none">
          GAMEWORKS
        </div>

        {/* Sub caption */}
        <div className="absolute flex gap-[16px] items-center right-[106px]" style={{ top: "calc(47% + 132px)" }}>
        ...
        {/* Glow blob grid with mask */}
        <div
          className="absolute -translate-x-1/2 left-1/2 grid grid-cols-8 grid-rows-2 w-[1600px] pointer-events-none"
          style={{
            top: "calc(47% - 100px)",
        ...
        >
          {glowColors.map((color, i) => (
            <div key={i} className="shrink-0 size-[200px] blur-[40px] rounded-full" style={{ backgroundColor: color }} />
          ))}
        </div>

        {/* Scroll hint */}
        <div className="absolute bottom-[48px] left-1/2 -translate-x-1/2 flex flex-col items-center gap-[8px] animate-bounce">
          <span className="font-medium text-[#0c0c0d] text-[14px] tracking-[-0.42px] opacity-60">scroll</span>
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M10 4v12M4 10l6 6 6-6" stroke="#0c0c0d" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" />
          </svg>
        </div>
      </div>
      ...
      <section id="about" className="flex flex-col gap-[100px] items-center py-[120px] w-full">
        <div className="flex flex-col items-center font-bold text-[50px] tracking-[-1.5px] whitespace-nowrap">
        ...
        <div className="flex gap-[80px] items-center px-[40px] w-full">
          <div className="relative h-[979px] w-[496px] shrink-0">
          ...
          <div className="flex flex-[1_0_0] flex-col gap-[200px] h-[805px] items-end justify-center min-w-0">
      ...
      <div className="overflow-hidden relative shrink-0 w-full h-[800px]" style={{ contain: "paint" }}>
        ...
        <div className="absolute top-[200px] w-full overflow-hidden" aria-hidden="true">
          <div
            className="flex whitespace-nowrap font-semibold text-[#ececec] text-[240px] leading-none"
      ...
      <section id="history" className="flex flex-col items-center w-full">
        <div className="flex h-[480px] items-center justify-center px-[40px] w-full">
          <span className="font-bold text-[#00204d] text-[143px] text-center leading-[1.24]">HISTORY</span>
        </div>

        <div className="relative h-[565px] w-full shrink-0">
          <div className="absolute bg-[#00204d] h-[465px] left-0 overflow-hidden top-0 w-[1023px]">
            <div className="absolute flex flex-col gap-[60px] items-start left-[133px] top-[102px] w-[443px]">
              ...
              <button className="border border-[#fafafa] border-[0.5px] px-[20px] py-[10px] rounded-[56px] bg-transparent transition-all duration-200 hover:bg-white/10 active:bg-white/20 cursor-pointer">
      ...
      <section id="event" className="flex flex-col items-center w-full">
        <div
          className="flex h-[480px] items-center justify-center px-[40px] w-full"
          style={{ background: "linear-gradient(to bottom, #fafafa, #b2d3ff)" }}
        >
          <span className="font-bold text-[#00204d] text-[143px] text-center leading-[1.24]">EVENT</span>
        </div>

        <div
          className="flex flex-col gap-[160px] items-center px-[40px] py-[80px] w-full"
          style={{ background: "linear-gradient(to bottom, #b2d3ff 0%, #b2d3ff 76%, #fafafa 100%)" }}
        >
          <EventCard
            title="벚꽃과 함께" titleHighlight="봄나들이"
            description={<>벚꽃이 가득한 봄에 동기들과 선배들과 <br />함께 놀러가요.</>}
            imgSrc={imgFrame3} imgStyle={{ height: "135.94%", left: "-0.44%", top: "-25.25%", width: "103.47%" }}
          />
          <EventCard
            reverse title="가르치고 배우는" titleHighlight="멘토링"
            description={<>기획, 개발, 디자인 분야 등 <br />지식 경험을 가르치고 배울 수 있어요.</>}
            imgSrc={imgFrame3} imgStyle={{ height: "135.94%", left: "-0.44%", top: "-25.25%", width: "103.47%" }}
          />
          <EventCard
            title="서로 친해지는" titleHighlight="짝선짝후"
            description={<>선배와 미션을 클리어하며 <br />서로 친해지는 시간을 가져요.</>}
            imgSrc={imgFrame4} imgStyle={{ height: "139.2%", left: "-1.69%", top: "-10.62%", width: "103.47%" }}
          />
          <EventCard
            reverse title="멋진 선배님과의" titleHighlight="커피챗"
            description="함께 커피를 마시며 노하우를 전수받고 진솔한 이야기를 나눠요."
            imgSrc={imgFrame3} imgStyle={{ height: "135.94%", left: "-0.44%", top: "-25.25%", width: "103.47%" }}
          />
          <EventCard
            title="대회를 경험해보는" titleHighlight="아이디어톤"
            description={<>여러 분야 간의 협업을 통해 <br />프로젝트 완성 과정을 경험해봐요.</>}
            imgSrc={imgFrame5} imgStyle={{ height: "138.49%", left: "-1.85%", top: "-24.48%", width: "103.68%" }}
          />
          <EventCard
            reverse title="다가온 여름에 함께" titleHighlight="MT"
            description={<>무더운 여름날 동기들과 함께 <br />즐거운 추억을 쌓아요.</>}
            imgSrc={imgFrame6} imgStyle={{ height: "231.99%", left: "0", top: "-82.61%", width: "100%" }}
          />

          <button className="border-b border-[#0c0c0d] flex items-center justify-center p-[8px] bg-transparent cursor-pointer transition-all duration-200 hover:gap-[12px] group">
            <span className="font-medium text-[#0c0c0d] text-[20px] text-center leading-none transition-all duration-200 group-hover:tracking-[0.02em]">
              더 많은 활동 보러가기→
            </span>
          </button>
        </div>
      ...
      <section id="people" className="flex flex-col items-center w-full">
        <div className="flex h-[480px] items-center justify-center px-[40px] w-full">
          <span className="font-bold text-[#00204d] text-[143px] text-center leading-[1.24]">PEOPLE</span>
        </div>

        <div className="flex flex-col gap-[40px] items-center px-[40px] pb-[80px] w-full">
          <div className="flex flex-col items-center text-[#0c0c0d] whitespace-nowrap">
          ...
          <div className="flex flex-col gap-[40px] items-center">
            <div className="flex gap-[40px] items-center">
              <MemberCard role="회장" name="장윤아" img={imgFrame7} style={{ height: "112.66%", left: "-3.52%", top: "-3.54%", width: "106.8%" }} />
              <MemberCard role="회장" name="조영찬" img={imgFrame8} style={{ height: "115.78%", left: "-4.82%", top: "-5.19%", width: "109.76%" }} />
              <MemberCard role="총무" name="박서영" img={imgFrame9} style={{ height: "121.45%", left: "-10.96%", top: "-7.3%", width: "115.94%" }} />
            </div>
            <div className="flex gap-[40px] items-center">
              <MemberCard role="부회장" name="유다은" img={imgFrame10} style={{ height: "111.61%", left: "-3.17%", top: "-5.98%", width: "105.81%" }} />
              <MemberCard role="부회장" name="최서정" img={imgFrame11} style={{ height: "111.78%", left: "-3.15%", top: "-5.74%", width: "105.97%" }} />
              <MemberCard role="부회장" name="최지원" img={imgFrame12} style={{ height: "110.35%", left: "-2.37%", top: "-5.22%", width: "104.61%" }} />
              <MemberCard role="부회장" name="홍준우" img={imgFrame13} style={{ height: "102.78%", left: "-12.76%", top: "-2.86%", width: "124.99%" }} />
            </div>
          </div>

          <button className="border-b border-[#0c0c0d] flex items-center justify-center p-[8px] bg-transparent cursor-pointer transition-all duration-200 group">
            <span className="font-medium text-[#0c0c0d] text-[20px] text-center leading-none group-hover:opacity-60 transition-opacity duration-200">
              역대 임원진 보러가기→
            </span>
          </button>
        </div>
      ...
      {/* ── CTA ── */}
      <section className="flex h-[600px] items-center justify-center px-[40px] w-full">
        <div className="flex flex-col gap-[40px] items-center w-[736px]">
          <div className="flex flex-col gap-[32px] items-center text-[#0c0c0d] text-center w-full">
            <span className="font-semibold text-[80px] tracking-[-3.2px] leading-[1.3] w-full">Ready to Join Us?</span>
            <span className="font-medium text-[36px] tracking-[-1.44px] leading-[1.3] w-full">
              지금 바로 GAMEWORKS의 새로운 멤버가 되어보세요!
            </span>
          </div>
          <button className="border border-[#0c0c0d] border-[0.5px] px-[20px] py-[10px] rounded-[56px] bg-transparent transition-all duration-200 hover:bg-[#0c0c0d] group cursor-pointer">
            <span className="font-medium text-[#0c0c0d] text-[24px] tracking-[-0.96px] leading-[1.3] whitespace-nowrap transition-colors duration-200 group-hover:text-[#fafafa]">
              GAMEWORKS 가입 바로가기
            </span>
          </button>
        </div>
